...
var n=b+g.NODE_TITLE_HEIGHT+2,t=this.mouse,r=g.isInsideRectangle(t[0],t[1],a,n,c,d);n=(t=this.last_click_position)&&g.isInsideRectangle(t[0],t[1],a,n,c,d);p.fillStyle=r?h:f;n&&(p.fillStyle="#AAA");p.beginPath();p.roundRect(a,b,c,d,[4]);p.fill();null!=e&&e.constructor==String&&(p.fillStyle=k,p.textAlign="center",p.font=(.65*d|0)+"px system-ui,p.fillText(e,a+.5*c,b+.75*d),p.textAlign="left");a=n&&!this.block_click;n&&this.blockClick();return a};m.prototype.isAreaClicked=function(a,b,c,d,e){var f=this.mouse;
g.isInsideRectangle(f[0],f[1],a,b,c,d);b=(a=(f=this.last_click_position)&&g.isInsideRectangle(f[0],f[1],a,b,c,d))&&!this.block_click;a&&e&&this.blockClick();return b};m.prototype.renderInfo=function(a,b,c){b=b||10;c=c||this.canvas.height-80;a.save();a.translate(b,c);a.font="10px system-ui"a.fillStyle="#888";a.textAlign="left";this.graph?(a.fillText("T: "+this.graph.globaltime.toFixed(2)+"s",5,13),a.fillText("I: "+this.graph.iteration,5,26),a.fillText("N: "+this.graph._nodes.length+" ["+this.visible_nodes.length+
...
a.length;++c){var d=a[c];if(F(this.visible_area,d._bounding)){b.fillStyle=d.color||"#335";b.strokeStyle=d.color||"#335";var e=d._pos,f=d._size;b.globalAlpha=.25*this.editor_alpha;b.beginPath();b.rect(e[0]+.5,e[1]+.5,f[0],f[1]);b.fill();b.globalAlpha=this.editor_alpha;b.stroke();b.beginPath();b.moveTo(e[0]+f[0],e[1]+f[1]);b.lineTo(e[0]+f[0]-10,e[1]+f[1]);b.lineTo(e[0]+f[0],e[1]+f[1]-10);b.fill();f=d.font_size||g.DEFAULT_GROUP_FONT_SIZE;b.font=f+"px system-ui"b.textAlign="left";b.fillText(d.title,e[0]+
