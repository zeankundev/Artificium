...
var r=b+f.NODE_TITLE_HEIGHT+2,u=this.mouse,q=f.isInsideRectangle(u[0],u[1],a,r,c,d);r=(u=this.last_click_position)&&f.isInsideRectangle(u[0],u[1],a,r,c,d);p.fillStyle=q?h:g;r&&(p.fillStyle="#AAA");p.beginPath();p.roundRect(a,b,c,d,[4]);p.fill();null!=e&&e.constructor==String&&(p.fillStyle=n,p.textAlign="center",p.font=(.65*d|0)+"px system-ui,p.fillText(e,a+.5*c,b+.75*d),p.textAlign="left");a=r&&!this.block_click;r&&this.blockClick();return a};k.prototype.isAreaClicked=function(a,b,c,d,e){var g=this.mouse;
f.isInsideRectangle(g[0],g[1],a,b,c,d);b=(a=(g=this.last_click_position)&&f.isInsideRectangle(g[0],g[1],a,b,c,d))&&!this.block_click;a&&e&&this.blockClick();return b};k.prototype.renderInfo=function(a,b,c){b=b||10;c=c||this.canvas.height-80;a.save();a.translate(b,c);a.font="10px system-ui"a.fillStyle="#888";a.textAlign="left";this.graph?(a.fillText("T: "+this.graph.globaltime.toFixed(2)+"s",5,13),a.fillText("I: "+this.graph.iteration,5,26),a.fillText("N: "+this.graph._nodes.length+" ["+this.visible_nodes.length+
...
a.length;++c){var d=a[c];if(B(this.visible_area,d._bounding)){b.fillStyle=d.color||"#335";b.strokeStyle=d.color||"#335";var e=d._pos,g=d._size;b.globalAlpha=.25*this.editor_alpha;b.beginPath();b.rect(e[0]+.5,e[1]+.5,g[0],g[1]);b.fill();b.globalAlpha=this.editor_alpha;b.stroke();b.beginPath();b.moveTo(e[0]+g[0],e[1]+g[1]);b.lineTo(e[0]+g[0]-10,e[1]+g[1]);b.lineTo(e[0]+g[0],e[1]+g[1]-10);b.fill();g=d.font_size||f.DEFAULT_GROUP_FONT_SIZE;b.font=g+"px system-ui"b.textAlign="left";b.fillText(d.title,e[0]+
