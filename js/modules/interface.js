...
function addGenericResource ( name, value, options, resource_classname )
{
	...
	var element = this.createWidget(name,"<span class='inputfield button'><input type='text' tabIndex='"+this.tab_index+"' class='text string' value='"+value+"' "+(options.disabled?"disabled":"")+"/></span><button title='show folders' class='micro'>"+(options.button || "<i class='material-symbols-outlined' style='font-size: 12px !important;'>folder</i>'") +"</button>", options);
