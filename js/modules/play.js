var PlayModule = {
	...
	init: function()
	{
		...
		container.innerHTML = "<button class='litebutton' id='play-button' title='Play'><i class='material-symbols-outlined'>play_arrow</i></button><button class='litebutton' id='pause-button' title='Pause' disabled><i class='material-symbols-outlined'>pause</i></button><button class='litebutton' id='stopkeep-button' disabled title='Stop And Save'><i class='material-symbols-outlined'>stop</i></button><button class='litebutton' id='restore-button' title='restore'>"+this.icons.reload+"</button><button class='litebutton' id='launch-button' title='launch'><i class='material-symbols-outlined'>eject</i></button>";
