...
InspectorWidget.prototype.init = function( options )
{
	...
	this.header = LiteGUI.createElement( "div", ".header", "<button class='litebutton prev icon' title='Previous'><i class='material-symbols-outlined'>arrow_back</i></button><span class='title'></span><button class='litebutton refresh icon' title='Refresh'><i class='material-symbols-outlined'>refresh</i></button><button class='litebutton lock icon' title='Lock'><i class='material-symbols-outlined'>lock</i></button><button class='litebutton next icon' title='Next'><i class='material-symbols-outlined'>arrow_forward</i></button>", { height: "26px" });
